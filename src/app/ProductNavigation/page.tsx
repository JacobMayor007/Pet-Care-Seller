        ...
        <div className="flex flex-row items-center gap-4" ref={profileRef}>
          <div className="relative cursor-pointer flex flex-row items-center gap-4  ">
            ...
            <div
              className={
                logout
                  ? `grid grid-rows-8 justify-center items-center bg-[#F3F3F3] drop-shadow-xl rounded-lg absolute top-10 -left-20 cursor-pointer h-fit w-56`
                  : `hidden`
              }
            >
...
const UserNotification = () => {
  ...
  return (
    <div className="overflow-y-scroll max-w-[500px] w-[482px] h-fit max-h-[542px] bg-white drop-shadow-lg rounded-xl justify-self-center flex flex-col pb-1">
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-12 my-2 col-span-11">
              <Link
                href={`/Transactions/${data?.order_ID}`}
